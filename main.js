...
function rectangleGrid(bbox, cellWidth, cellHeight, options) {
    ...
    if (!helpers.isNumber(cellWidth)) throw new Error('cellWidth is invalid');
    if (!helpers.isNumber(cellHeight)) throw new Error('cellHeight is invalid');
...
module.exports = rectangleGrid;
module.exports.default = rectangleGrid;
